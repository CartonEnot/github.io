...
[Введение](#введение)  
&nbsp;[Поиск информации в сети Интернет](#поиск-информации-в-сети-интернет)  
&nbsp;&nbsp;1. [Поиск в каталогах информационных ресурсов](#1.-поиск-в-каталогах-информационных-ресурсов)  
&nbsp;&nbsp;2. [Поиск с помощью поисковых машин](#поиск-с-помощью-поiskovyh-mashin)  
&nbsp;[Поиск информации в сети Интернет и анализ найденных документов](#поиск-информации-в-сети-интернет-и-анализ-найденных-документов)  
